      ...
      child: TRoundedContainer(
        ...
        child: Row(
          ...
          children: [
            ...
            /// -- Texts
            /// Expanded and Column Main Axis Size is important to keep the elements in vertical center and also to keep inside the boundaries
            Expanded(child: Column(
              mainAxisSize: MainAxisSize.min,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const TBrandTitleWithVerifiedIcon(title: 'Nike', brandTextSize: TextSizes.large,),
                Text('256 Total Products',overflow: TextOverflow.ellipsis,style: Theme.of(context).textTheme.labelMedium),
